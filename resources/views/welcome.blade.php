                ...
                <div class="row align-items-center">
                    <div class="col-lg-8 col-md-9">
                        <div class="title-heading mt-4">
                            <h1 class="display-3 font-weight-bold mb-3">Hey! <small>I make...</small><br> <span class="element" data-elements="Websites, Android Applications, IOS Applications"></span> </h1>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 mt-4 pt-2">
                        <div class="blog position-relative overflow-hidden shadow rounded">
                            ...
                            <h4><a href="javascript:void(0)" class="title text-dark">{{ $post->name }}</a></h4>
