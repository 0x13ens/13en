<!DOCTYPE html>
    ...
    <head>
        <meta charset="utf-8" />
        <title>Ben Middleton Computer Scientist - 13en.dev</title>
    ...
    <body>
        ...
        <header id="topnav" class="defaultscroll sticky">
            <div class="container">
                <!-- Logo container-->
                <div>
                    <a class="logo" href="/">Ben Middleton<span class="text-primary">.</span></a>
                </div>
                <div class="buy-button">
                    <a href="https://github.com/0x13ens" target="_blank" class="btn btn-primary">My Github</a>
                ...
                <div id="navigation">
                    ...
                    <ul class="navigation-menu">
                        ...
                        <li class="has-submenu">
                            <a href="/portfolio">Portfolio</a><span class="menu-arrow"></span>
                            <ul class="submenu">
                                <li class="has-submenu"><a href="javascript:void(0)"> Websites</a><span class="submenu-arrow"></span>
                                    <ul class="submenu">
                                ...
                                <li class="has-submenu"><a href="javascript:void(0)">Android</a><span class="submenu-arrow"></span>
                                    <ul class="submenu">
                                ...
                                <li class="has-submenu"><a href="javascript:void(0)"> IOS</a><span class="submenu-arrow"></span>
                                    <ul class="submenu">
                                ...
                                <li class="has-submenu"><a href="javascript:void(0)"> macos</a><span class="submenu-arrow"></span>
                                    <ul class="submenu">
                        ...
                        <li class="has-submenu">
                            <a href="/blog">Thoughts</a><span class="menu-arrow"></span>
                            <ul class="submenu">
                                <li><a href="page-services.html"> Product Reviews</a></li>
                                <li><a href="page-aboutus.html"> Software Reviews</a></li>
                                <li><a href="page-pricing.html"> Tutorials</a></li>
                                <li><a href="page-team.html"> Thoughts</a></li>
                            </ul>
                        </li>
        ...
        <!-- Hero Start -->
        <section class="bg-home bg-light d-flex align-items-center" style="background:url('images/personal/bg01.png') center center" id="home">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-8 col-md-9">
                        <div class="title-heading mt-4">
                            <h1 class="display-3 font-weight-bold mb-3">Hey!<br> <span class="element" data-elements="App Developer, Web Developer, Dashboard Developer, Thats me -->"></span> </h1>
                            <p class="para-desc text-muted">
                                I’m a Web/Software Developer located in England, Plymouth currently studying towards a Computer Science degree.</p>
                            <div class="mt-4 pt-2">
        ...
        <section class="section">
                ...
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <div class="section-title">
                            ...
                            <h6 class="text-primary mb-4">I'm Passionate Web\Software Developer</h6>
            ...
            <div class="container mt-100 mt-60" id="portfolio">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 mt-4 pt-2">
                        <div class="work-container position-relative d-block overflow-hidden rounded">
                            ...
                            <div class="content personal-port">
                                <a href="page-work-detail.html" class="title text-white d-block font-weight-bold">{{ $portfolio->name }}</a>
                            <small class="text-light">{{ $portfolio->idea }}</small>
                            </div>
                            <div class="client personal-port">
                                <small class="text-light user d-block"><i class="mdi mdi-account"></i> Ben Middleton</small>
                    ...
                    <div class="col-lg-4 col-md-6 mt-4 pt-2">
                        <div class="work-container position-relative d-block overflow-hidden rounded">
                            <a class="mfp-image d-inline-block" href="images/personal/4.jpg" title="">
                                <img src="images/personal/4.jpg" class="img-fluid rounded" alt="work-image">
                                <div class="overlay-work"></div>
                            </a>
                            <div class="content personal-port">
                    ...
                    <div class="col-lg-4 col-md-6 mt-4 pt-2">
                        <div class="work-container position-relative d-block overflow-hidden rounded">
                            <a class="mfp-image d-inline-block" href="images/personal/5.jpg" title="">
                                <img src="images/personal/5.jpg" class="img-fluid rounded" alt="work-image">
                                <div class="overlay-work"></div>
                            </a>
                            <div class="content personal-port">
                    ...
                    <div class="col-lg-4 col-md-6 mt-4 pt-2">
                        <div class="work-container position-relative d-block overflow-hidden rounded">
                            <a class="mfp-image d-inline-block" href="images/personal/6.jpg" title="">
                                <img src="images/personal/6.jpg" class="img-fluid rounded" alt="work-image">
                                <div class="overlay-work"></div>
                            </a>
                            <div class="content personal-port">
                    ...
                    <div class="col-12 mt-4 pt-2">
                        <a href="portfolio" class="btn btn-outline-primary">See More <i class="mdi mdi-chevron-right"></i></a>
                    </div><!--end col-->
                </div><!--end row-->
            </div><!--end container-->
            ...
            <div class="container mt-100 mt-60">
                ...
                <div class="row">
                    <div class="col-md-4 mt-4 pt-2" >
                        <div class="work-process p-lg-4 p-3 rounded shadow">
                            ...
                            <ul class="list-unstyled mb-0 mt-2">
                                <li class="step-icon float-right"><i class="mdi mdi-chevron-double-right"></i></li>
                                <li class="step font-weight-bold">Step 01.</li>
                            </ul>
                        </div>
                    </div><!--end col-->
                    ...
                    <div class="col-md-4 mt-4 pt-2">
                        <div class="work-process p-lg-4 p-3 rounded shadow">
                            ...
                            <ul class="list-unstyled mb-0 mt-2">
                                <li class="step-icon float-right"><i class="mdi mdi-chevron-double-right"></i></li>
                                <li class="step font-weight-bold">Step 02.</li>
                            </ul>
                        </div>
                    </div><!--end col-->
                    ...
                    <div class="col-md-4 mt-4 pt-2">
                        <div class="work-process p-lg-4 p-3 rounded shadow">
                            ...
                            <a href="javascript:void(0)" class="text-primary">Read more <i class="mdi mdi-chevron-right"></i></a>
                            <ul class="list-unstyled mb-0 mt-2">
                                <li class="step-icon float-right"><i class="mdi mdi-check-all"></i></li>
                                <li class="step font-weight-bold">Step 03.</li>
                            </ul>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
                    ...
                    <div class="col-lg-7 text-center">
                        <div id="owl-fade" class="owl-carousel owl-theme">
                            <div class="customer-testi text-center">
                                ...
                                <img src="images/client/01.jpg" class="img-fluid avatar avatar-small mt-3 rounded-pill mx-auto shadow" alt="">
                            ...
                            <div class="customer-testi text-center">
                                ...
                                <img src="images/client/02.jpg" class="img-fluid avatar avatar-small mt-3 rounded-pill mx-auto shadow" alt="">
                            </div><!--end customer testi-->
                            ...
                            <div class="customer-testi text-center">
                                ...
                                <img src="images/client/03.jpg" class="img-fluid avatar avatar-small mt-3 rounded-pill mx-auto shadow" alt="">
                            </div><!--end customer testi-->
                            ...
                            <div class="customer-testi text-center">
                                ...
                                <img src="images/client/04.jpg" class="img-fluid avatar avatar-small mt-3 rounded-pill mx-auto shadow" alt="">
                            </div><!--end customer testi-->
                            ...
                            <div class="customer-testi text-center">
                                ...
                                <img src="images/client/05.jpg" class="img-fluid avatar avatar-small mt-3 rounded-pill mx-auto shadow" alt="">
                            </div><!--end customer testi-->
                            ...
                            <div class="customer-testi text-center">
                                ...
                                <img src="images/client/06.jpg" class="img-fluid avatar avatar-small mt-3 rounded-pill mx-auto shadow" alt="">
                            </div><!--end customer testi-->
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 mt-4 pt-2">
                        <div class="blog position-relative overflow-hidden shadow rounded">
                            <div class="position-relative">
                                <img src="images/personal/1.jpg" class="img-fluid rounded-top" alt="">
                    ...
                    <div class="col-lg-4 col-md-6 mt-4 pt-2">
                        <div class="blog position-relative overflow-hidden shadow rounded">
                            <div class="position-relative">
                                <img src="images/personal/2.jpg" class="img-fluid rounded-top" alt="">
                                <div class="overlay rounded-top bg-dark"></div>
                            </div>
                            <div class="content p-4">
                    ...
                    <div class="col-lg-4 col-md-6 mt-4 pt-2">
                        <div class="blog position-relative overflow-hidden shadow rounded">
                            <div class="position-relative">
                                <img src="images/personal/3.jpg" class="img-fluid rounded-top" alt="">
                                <div class="overlay rounded-top bg-dark"></div>
                            </div>
                            <div class="content p-4">
                    ...
                    <div class="col-12 mt-4 pt-2">
                        <a href="page-blog.html" class="btn btn-primary">See More <i class="mdi mdi-chevron-right"></i></a>
                    </div><!--end col-->
                </div><!--end row-->
            </div><!--end container-->
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="text-sm-left">
                            <p class="mb-0">© 2019-20 13en.dev.</p>
                        </div>
                    </div>
